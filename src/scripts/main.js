...
const addRow = person => {
  ...
  addCell(tr, person.name);
  addCell(tr, person.sex === 'm' ? 'Male' : 'Female');
  addCell(tr, person.born);
  addCell(tr, person.died);
  addCell(tr, person.died - person.born);
  addCell(tr, Math.ceil(person.died / 100));
