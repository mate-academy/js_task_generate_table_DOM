...
people.forEach((person) => {
  ...
  const senturyCell = document.createElement('td');
  ...
  senturyCell.textContent = Math.ceil(person.died / 100);

  tablerow.appendChild(nameCell);
  tablerow.appendChild(genderCell);
  tablerow.appendChild(bornCell);
  tablerow.appendChild(diedCell);
  tablerow.appendChild(ageCell);
  tablerow.appendChild(senturyCell);
