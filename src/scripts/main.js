...
people.forEach((element) => {
  document.querySelector('table.dashboard tbody').insertAdjacentHTML(
    'beforeend',
    `<tr>
     <td>${element.name}</td>
     <td>${genderRecognition(element.sex)}</td>
     <td>${element.born}</td>
     <td>${element.died}</td>
...
function genderRecognition(letter) {
  return letter === 'm' ? 'Male' : 'Female';
}
