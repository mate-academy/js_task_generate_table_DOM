...
people.forEach((peop) => {
  ...
  td1.textContent = peop.name;
  tr.append(td1);

  let td2 =  document.createElement('td');
  if (peop.sex === 'm') {
    td2.textContent = 'Male';
  } else {
  ...
  td3.textContent = peop.born;
  tr.append(td3);

  let td4 =  document.createElement('td');
  td4.textContent = peop.died;
  tr.append(td4);

  let td5 =  document.createElement('td');
  td5.textContent = peop.died - peop.born;
  tr.append(td5);

  let td6 =  document.createElement('td');
  td6.textContent = Math.ceil(peop.died / 100);
  tr.append(td6);
