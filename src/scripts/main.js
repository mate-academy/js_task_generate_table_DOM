...
function convertToTable(persons) {
  persons.forEach((element) => {
    ...
    born.textContent = element.born;
    died.textContent = element.died;
    age.textContent = element.died - element.born;
    century.textContent = Math.ceil(element.died / 100);
