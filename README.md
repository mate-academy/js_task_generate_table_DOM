1. Replace `<your_account>` with your Github username in the link
    - [DEMO LINK](https://IzzetYusufov.github.io/js_task_generate_table_DOM/)
...
In `main.js`, `people.json`. Variable `people` contains an array of people, you can check it by using `console.log`.
